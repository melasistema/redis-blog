...
*   🚀 Nuxt.js 3 Frontend & API
*   ⚡ Redis Stack as the Primary Database (using RedisJSON)
*   🎨 Customizable Theming via \`config/blog.config.ts\`
*   📝 **Markdown Support** for writing posts.
*   ⚙️ Feature Toggles for pagination, post navigation, and excerpts.
...
Here’s a quick demonstration of what you can do:
...
Ever wondered how this boilerplate works? Here’s a high-level look at the architecture.
...
`,
                ...
                excerpt: `If you're a developer roaming the cosmic void in search of the perfect blogging platform — one fast enough to outrun hyperspace lag, simple enough to configure from a single holocron file, and powered by the mighty Force of Redis — your quest ends here.`,
                image: '/images/redis-blog-poster-image.jpg',
            }
        ];
